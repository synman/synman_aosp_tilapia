...
public class DisplaySettings extends SettingsPreferenceFragment implements
    ...
    private CheckBoxPreference mTabletUiMode;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mTabletUiMode = (CheckBoxPreference) findPreference(Settings.Global.TABLET_UI_MODE);
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if (preference == mTabletUiMode) {
            Settings.Global.putInt(getContentResolver(), Settings.Global.TABLET_UI_MODE, mTabletUiMode.isChecked() ? 1 : 0);
        }
