...
class GlobalActions implements DialogInterface.OnDismissListener, DialogInterface.OnClickListener  {
    ...
    private GlobalActionsDialog createDialog() {
        ...
        for (int i = 0; i < defaultActions.length; i++) {
            ...
            if (GLOBAL_ACTION_KEY_POWER.equals(actionKey)) {
                ...
                mItems.add(new RebootPowerAction());
                mItems.add(new RebootRecoveryPowerAction());
    ...
    private final class RebootPowerAction extends SinglePressAction implements LongPressAction {
        private RebootPowerAction() {
    ...
    private final class RebootRecoveryPowerAction extends SinglePressAction implements LongPressAction {
        private RebootRecoveryPowerAction() {
            super(com.android.internal.R.drawable.ic_menu_manage,
        ...
        public void onPress() {
            // shutdown by making sure radio and power are handled accordingly.
                mWindowManagerFuncs.reboot("recovery", true);
        }
    }
